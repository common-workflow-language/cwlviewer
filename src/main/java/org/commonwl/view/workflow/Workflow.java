...
public class Workflow {
    ...
    public String getPermalink() {
        String packedPart = (retrievedFrom.getPackedId() != null) ? "%23" + retrievedFrom.getPackedId() : "";
        return "https://w3id.org/cwl/v/git/" + lastCommit + "/" + retrievedFrom.getPath() + packedPart;
    }
}
