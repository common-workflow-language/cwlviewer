...
public class GitDetailsTest {
  ...
  private static final GitDetails GITHUB_DETAILS =
      new GitDetails(
          "https://github.com/owner/repoName.git", "branch", "path/within/structure.cwl");
  private static final GitDetails GITLAB_DETAILS =
      new GitDetails(
          "https://gitlab.com/owner/repoName.git", "branch", "path/within/structure.cwl");
  private static final GitDetails BITBUCKET_DETAILS =
      new GitDetails(
          "https://bitbucket.org/owner/repoName.git", "branch", "path/within/structure.cwl");
  private static final GitDetails GENERIC_DETAILS =
      new GitDetails("https://could.com/be/anything.git", "branch", "path/within/structure.cwl");
  private static final GitDetails PACKED_DETAILS =
      new GitDetails(
          "https://could.com/be/anything.git", "branch", "path/within/structure/packed.cwl#testId");
  ...
  public void getPath() throws Exception {
    ...
    GitDetails details2 =
        new GitDetails("https://repo.url/repo.git", "branch", "test/directory/structure.cwl");
  ...
  public void getUrl() throws Exception {
    ...
    assertEquals(
        "https://github.com/owner/repoName/blob/overrideBranch/path/within/structure.cwl",
        GITHUB_DETAILS.getUrl("overrideBranch"));
    assertEquals(
        "https://gitlab.com/owner/repoName/blob/branch/path/within/structure.cwl",
        GITLAB_DETAILS.getUrl());
    assertEquals("https://could.com/be/anything.git", GENERIC_DETAILS.getUrl());
    assertEquals(
        "https://bitbucket.org/owner/repoName/src/branch/path/within/structure.cwl",
        BITBUCKET_DETAILS.getUrl());
  }
  ...
  public void getInternalUrl() throws Exception {
    ...
    assertEquals(
        "/workflows/gitlab.com/owner/repoName/blob/branch/path/within/structure.cwl",
        GITLAB_DETAILS.getInternalUrl());
    assertEquals(
        "/workflows/bitbucket.org/owner/repoName.git/branch/path/within/structure.cwl",
        BITBUCKET_DETAILS.getInternalUrl());
    assertEquals(
        "/workflows/could.com/be/anything.git/branch/path/within/structure.cwl",
        GENERIC_DETAILS.getInternalUrl());
    assertEquals(
        "/workflows/could.com/be/anything.git/branch/path/within/structure/packed.cwl#testId",
        PACKED_DETAILS.getInternalUrl());
  }
  ...
  public void getRawUrl() throws Exception {
    ...
    assertEquals(
        "https://gitlab.com/owner/repoName/raw/branch/path/within/structure.cwl",
        GITLAB_DETAILS.getRawUrl());
    assertEquals(
        "https://bitbucket.org/owner/repoName/raw/branch/path/within/structure.cwl",
        BITBUCKET_DETAILS.getRawUrl());
